...
The extension offers the following tools for Co-Pilot:

- `getFunctions()` provides a list of the available Septic functions that can be used in an alg
- `getVariables()` provides a list of all available Septic variables for the given context
